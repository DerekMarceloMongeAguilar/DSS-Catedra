...
$pdf->SetTitle(utf8_decode("Facturación Clientes - Aco emprendedores"));
$pdf->AliasNbPages();
$pdf->AddPage();
// CONTENIDO DE REPORTE [DOCUMENTO]
$pdf->SetFont('Arial', '', 10);
$pdf->setTextColor(255, 255, 255);
$pdf->MultiCell(191, 8, utf8_decode("Facturación Aco Emprendedores"), 0, 'R');
...
$pdf->SetFont('Arial', '', 8);
$pdf->Ln(5);
$pdf->MultiCell(190, 4, utf8_decode("Estimado(a) cliente. Agradecemos su pago efectuado, le recordamos ser puntual para así tener una excelente calificación crediticia. Cualquier consulta, duda y/o reclamo puede efectuarlo en nuestros teléfonos 2255-0090, 2255-0091 y 2255-0192 o a nuestro correo electrónico servicioalcliente@acoemprendedores.com específicando el número de transacción que se encuentra en la parte superior de este documento. Trabajamos duro cada día para darle un excelente servicio a cada uno de nuestros clientes."));
$pdf->Ln(45);
$pdf->SetFont('Arial', '', 7);
$pdf->MultiCell(190, 4, utf8_decode("COMPROBANTE OFICIAL DE CANCELACIÓN ACO EMPRENDEDORES  S.A DE C.V ~ " . $Gestiones->getReferenciaTransaccionCreditosClientes()), 0, 'C');
