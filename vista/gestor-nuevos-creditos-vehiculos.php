...
?>
        ...
        <head>
            ...
            <title>Aco Emprendedores | Gestor Nuevos Pr&eacute;stamos Veh&iacute;culos</title>
            <!-- Favicon icon -->
                            ...
                            <div class="authincation-content">
                                <div class="row no-gutters">
                                    ...
                                    */
                                                                    ...
                                                                    <div class="row form-validation">
                                                                        <div class="col-lg-12 mb-2">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="text-label">Producto Aco Emprendedores Seleccionado<span class="text-danger">*</span></label>
                                                                                <div class="col-lg-12">
                                            ...
                                            <h6 class="text-center">&copy; Copyright <?php echo date('Y'); ?> ACO EMPRENDEDORES </h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
