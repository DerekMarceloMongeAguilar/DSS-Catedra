												...
												<table style="width: 100%;" id="example5" class="display min-w850">
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															echo $UrlGlobal;
															echo 'controlador/cGestionesCashman.php?cashmanhagestion=retiros-cuentas-ahorros-atencion-clientes&idusuario=';
															echo $filas['idusuarios'];
															echo '"><i class="ti-wallet"></i> Retirar de Cuenta</a>
                                                            <a class="dropdown-item" href="';
															echo $UrlGlobal;
															echo 'controlador/cGestionesCashman.php?cashmanhagestion=deposito-cuentas-ahorros-atencion-clientes&idusuario=';
															echo $filas['idusuarios'];
