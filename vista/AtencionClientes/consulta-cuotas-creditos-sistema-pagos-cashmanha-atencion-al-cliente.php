...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Sistema Pagos Cr&eacute;ditos </title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Pagadur&iacute;a Clientes </h4>
                                </div>
                            </div>
                                                    ...
                                                    <div class="card-body  p-4">
                                                        <div class="media ai-icon">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <h4 <?php if ($Gestiones->getMontoFinanciamientoCreditos() >= 100000 && $Gestiones->getMontoFinanciamientoCreditos() <= 999999) {
                                                                        echo 'style="font-size: 1.4rem"';
                                                                    } else if ($Gestiones->getMontoFinanciamientoCreditos() >= 1000000) {
                                                    ...
                                                    <div class="card-body  p-4">
                                                        <div class="media ai-icon">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <h4 <?php if ($Gestiones->getSaldoActualCreditos() >= 100000 && $Gestiones->getSaldoActualCreditos() <= 999999) {
                                                                        echo 'style="font-size: 1.4rem"';
                                                                    } else  if ($Gestiones->getSaldoActualCreditos() >= 1000000) {
                                                                        echo 'style="font-size: 1.3rem"';
						...
						<tr>
                            ...
                            <td>';
                                                            if ($filas['estadocuota'] == "pendiente") {
                                                                echo '<a href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCashman.php?cashmanhagestion=orden-pago-creditos-cashmanha-clientes-atencion-al-cliente&idcuota=';
                                                                echo $filas['idcuotas'];
                                                                echo '&idusuario=';
