                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos </h4><br>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-productos-especifica-cashmanha-atencion-clientes&idproducto=';
                                        ...
                                        <div class="tab-pane fade" id="profile8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos Inactivos</h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
                                        ...
                                        <div class="tab-pane fade" id="profile9" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos Expirados </h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
