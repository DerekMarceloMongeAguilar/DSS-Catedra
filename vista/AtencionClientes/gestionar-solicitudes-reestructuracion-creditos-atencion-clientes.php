...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Gestionar Nuevos Cr&eacute;ditos</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    Gesti&oacute;n de Nuevos Cr&eacute;ditos
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Consulta Reestructuraci&oacute;n Cr&eacute;ditos Clientes</h4><br>
                                        <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                        $PrimerNombre = explode(' ', $Nombre, 2);
                                                        print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los usuarios los cuales usted gestiono una solicitud de cr&eacute;dito y por un motivo ha sido marcado desde el departamento de gerencia que necesita ser reestructurado.</p>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<td><a href="javascript:void()" class="badge badge-circle badge-outline-info">';
                                                        echo $filas['nit'];
                                                        echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-circle badge-outline-danger">';
                                                        echo $filas['estado'];
                                                        echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-circle badge-outline-danger">' . $filas['fechasolicitud'] . '</a></td>
                                                    <td>
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo '"><i class="ti ti-wallet"></i> Reestructurar Nuevo Cr&eacute;dito</a>
														</div>
													</div>
												</td>									
												</tr>
