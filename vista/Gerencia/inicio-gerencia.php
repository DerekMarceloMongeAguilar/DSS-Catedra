                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body row sp16">
                                    ...
                                    <div class="col-xl-6 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-dark border-danger border border-danger media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Cuotas Canceladas Tarde</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600"><?php echo $Gestiones->getNumeroCuotasPagadasTarde(); ?></h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3" src="<?php echo $UrlGlobal; ?>vista/images/warning.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-dark border-success border border-success media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Cuotas Procesadas / Canceladas</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600"><?php echo $Gestiones->getNumeroCuotasPagadasCanceladas(); ?></h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3" src="<?php echo $UrlGlobal; ?>vista/images/handshake.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-dark border-dark border border-dark media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Cuentas Vencidas / No Procesadas</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600"><?php echo $Gestiones->getNumeroCuotasVencidas(); ?></h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3" src="<?php echo $UrlGlobal; ?>vista/images/no.gif" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 mb-3 col-lg-12 col-md-6">
                                        <div class="bgl-dark border-primary border border-primary media align-items-center p-4">
                                            <div class="media-body">
                                                <span class="fs-14 font-w600">Transferencias Procesadas</span>
                                                <h2 class="text-black fs-28 mb-2 font-w600"><?php echo $Gestiones->getNumeroTransferenciasProcesadas(); ?></h2>
                                            </div>
                                            <img style="width: 4em;" class="mr-3" src="<?php echo $UrlGlobal; ?>vista/images/safe-box.gif" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
