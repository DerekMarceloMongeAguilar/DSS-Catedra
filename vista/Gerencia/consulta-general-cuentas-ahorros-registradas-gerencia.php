...
?>
	...
	<head>
		...
		<title>Aco Emprendedores | Consulta General Roles de Usuarios</title>
		<!-- Favicon icon -->
							...
							<div class="card-body">
								...
								<div class="tab-content tabcontent-border">
									<div class="tab-pane fade show active" id="home8" role="tabpanel">
										<div class="pt-4">
											<h4>Consultar, Gestionar Cuentas de Ahorros Clientes</h4><br>
											<p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
															$PrimerNombre = explode(' ', $Nombre, 2);
															print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todas las cuentas de ahorro registradas. Ac&aacute; podr&aacute;s consultar las respectivas cuentas de los clientes<strong> Para filtrar resultados, solamente d&iacute;gita el n&uacute;mero de DUI; o bien el n&uacute;mero de cuenta del cliente en el buscador.</strong></p>
												...
												<table style="width: 100%;" id="example5" class="display min-w850">
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															echo $UrlGlobal;
															echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-transacciones-general-cuentas-clientes-gerencia&idusuariocuenta=';
