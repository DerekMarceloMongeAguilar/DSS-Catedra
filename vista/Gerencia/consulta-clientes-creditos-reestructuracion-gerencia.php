...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Listado Solicitudes Cr&eacute;ditos Reestructuraci&oacute;n </title>
        <!-- Favicon icon -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Reestructurar Solicitudes Cr&eacute;ditos Clientes</h4><br>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="javascript:void(0)"><i class="ti-eye"></i> No hay nada que mostrar....</a>
