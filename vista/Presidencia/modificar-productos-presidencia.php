...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Modificar Producto <?php echo $Gestiones->getNombreProductos(); ?></title>
        <!-- Favicon icon -->
                                ...
                                <div class="accordion__item">
                                    ...
                                    <div id="with-icon_collapseOne" class="accordion__body collapse" data-parent="#accordion-six">
                                        <div class="accordion__body--text">
                                            <i class="ti-direction"></i> Estimado(a), por favor a la hora de editar los requisitos de productos, separe por comas <strong>[ , ] </strong> los diferentes apartados. Adem&aacute;s tome en cuenta que los c&oacute;digos &uacute;nicos solamente deben llevar 10 caracteres.
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
