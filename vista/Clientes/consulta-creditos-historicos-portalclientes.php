...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Listado Solicitudes Cr&eacute;ditos Cancelados (Hist&oacute;rico) </title>
        <!-- Favicon icon -->
    ...
    ***********************************-->
        ...
        ***********************************-->
            <?php
            // IMPORTAR MENU DE NAVEGACION PARA USUARIOS ROL CLIENTES
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Solicitudes Cr&eacute;ditos Cancelados Clientes [Hist&oacute;rico]</h4><br>
                                        <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                        $PrimerNombre = explode(' ', $Nombre, 2);
                                                        print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todas tus solicitudes que han sido canceladas y han pasado a formar parte del hist&oacute;rico de cr&eacute;ditos. Puedes consultar el estado de cuenta que en su momento estuvo activo.</strong></p>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
												...
												<td>
                                                    <a target="_blank" style="width: 100%" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-especifica-solicitudes-creditos-canceladas-historico-portal-clientes&idusuario=';
