                            ...
                            <div class="col-xl-12">
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <form action="../controlador/cGestionesCashman.php?cashmanhagestion=validacion-datos-transferencia-otras-cuentas-clientes-portal-clientes" class="form-valide" method="POST" autocomplete="off">
