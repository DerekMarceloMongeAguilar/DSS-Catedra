...
?>
		...
		<head>
			...
			<title>Aco Emprendedores | Reestructuraci&oacute;n de <?php echo $Gestiones->getNombreProductos(); ?> </title>
			<!-- Favicon icon -->
									...
									<div class="card overflow-hidden">
										...
										<div class="card text-white bg-light text-black">
											<ul class="list-group list-group-flush">
												...
												<li class="list-group-item d-flex justify-content-between"><span class="mb-0"><i class="ti ti-shift-right-alt"></i> Monto Financiamiento Cr&eacute;dito :</span><strong>$<?php echo $Gestiones->getMontoFinanciamientoCreditos(); ?> USD</strong></li>
												...
												<li class="list-group-item d-flex justify-content-between"><span class="mb-0"><i class="ti ti-shift-right-alt"></i> Cuota Mensual Asignada Cr&eacute;dito :</span><strong>$<?php echo $Gestiones->getCuotaMensualCreditos(); ?> USD</strong></li>
												<li class="list-group-item d-flex justify-content-between"><span class="mb-0"><i class="ti ti-shift-right-alt"></i> Ingresos Declarado Por Cliente :</span><strong>$<?php echo $Gestiones->getSalarioClienteCreditos(); ?> USD</strong></li>
									...
									<div class="card-body">
										<div class="alert alert-danger alert-dismissible alert-alt fade show">
											<strong>Tomar Nota:</strong> Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
																						$PrimerNombre = explode(' ', $Nombre, 2);
																						print_r($PrimerNombre[0]); ?>, esta solicitud de cr&eacute;dito ha sido marcada que necesita una reestructuraci&oacute;n. Por favor siga las indicaciones del siguiente mensaje.<br><br>Motivo de reestructuraci&oacute;n: <strong><?php echo $Gestiones->getObservacionesGerenciaCreditos(); ?></strong>
										</div>
										<!-- Nav tabs -->
										...
										<div class="tab-content tabcontent-border">
											<div class="tab-pane fade show active" id="home8" role="tabpanel">
												<div class="pt-4">
													<h4>Reestructuraci&oacute;n de Cr&eacute;ditos</h4><br>
													<p>Por favor atienda las indicaciones, <strong>NO tiene autorizado el cambio de m&aacute;s valores a los que la indicaci&oacute;n estipula.</strong> Recuerde que su gesti&oacute;n queda guardada en nuestro sistema, y el cliente posee una copia de la solicitud de cr&eacute;dito inicial. <strong>En caso el cliente no acceda a una sugerencia de reestructuraci&oacute;n solamente cambie el estado sin cambiar ning&uacute;n otro valor.</strong></p><br>
													<div class="col-xl-12">
															...
															<div class="row form-validation">
																<div class="col-lg-12 mb-2">
																	...
																	<div class="form-group">
																		<label class="text-label">Producto Seleccionado<span class="text-danger">*</span></label>
																		<div class="col-lg-12">
																	...
																	<div class="form-group">
																		...
																		<div class="col-lg-12">
																			<select class="form-control" class="tipoclientecredito" id="valestadoinicialcreditos" name="valestadoinicialcreditos">
																				...
																				<option value="aprobacioninicial">Cr&eacute;dito Aprobado</option>
																			</select>
																		</div>
																	</div>
																</div>
																...
																<!-- ENVIO DATOS -->
																<button type="submit" id="enviar-datos-creditos" class="btn light btn-success"><i class="ti-hand-point-right"></i> Reestructurar Solicitud de Cr&eacute;dito</button>
														</form>
