...
if ($_SESSION['comprobar_iniciosesion_primeravez'] == "si") {
    ...
    if ($Gestiones->getComprobacion_EnviarAlHistoricoClientes() == "si") {
...
?>
        ...
        <title>Aco Emprendedores | Estado Cuenta Cr&eacute;ditos Clientes <?php echo $Gestiones->getComprobacion_EnviarAlHistoricoClientes(); ?> </title>
        <!-- Favicon icon -->
    ...
    ';
        ...
        if ($Gestiones->getEstadoActualCreditos() == "cancelado") {
            echo '
        <div class="col-xl-12">
        ...
        if ($Gestiones->getEstadoActualCreditos() == "cancelado") {
            echo 'id="ingreso-datos-cuotas-mensuales-clientes-historico" ';
        }
        echo ' method="post">
        ...
        echo round($CalculoCuotaMensualCapital, 2);
        echo '">';
        ...
        echo '<input type="hidden" name="MontoFinanciemientoCreditosClientes" value="';
        echo $Gestiones->getMontoFinanciamientoCreditos();
        echo '">';
        echo '<input type="hidden" name="InteresFinanciemientoCreditosClientes" value="';
        echo $Gestiones->getTasaInteresCreditos();
        echo '">';
        if ($Gestiones->getComprobarEstadoCuotasMensuales() == "no") {
        ...
        if ($Gestiones->getEstadoActualCreditos() == "cancelado") {
            echo '<button id="registro_solicitud" onclick="AlertaProcesamientoDatos()" style="margin: .5rem;" type="submit" class="btn btn-rounded btn-success"><span class="btn-icon-left text-success"><i class="fa fa-upload color-success"></i></span>Registrar Solicitud Crediticia (Hist&oacute;rico)</button>';
        }
        echo '
...
*/
        ...
        if ($Gestiones->getComprobarEstadoCuotasMensuales() == "no" || $Gestiones->getEstadoActualCreditos() == "cancelado") {
        ?>
            ...
            <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-registro-cuotas-mensuales-creditos-clientes-historico.js"></script>
            <!--
            <script src="<?php #echo $UrlGlobal; 
                            ?>vista/js/alerta-registro-solicitud-crediticia-clientes-historico.js"></script> -->
