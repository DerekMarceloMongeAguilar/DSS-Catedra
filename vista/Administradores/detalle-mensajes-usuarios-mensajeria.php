...
if (empty($Gestiones->getIdMensajeria())) {
				...
				<div class="container-fluid">
					<div class="page-titles">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="javascript:void(0)">Detalle Mensajes</a></li>
						</ol>
					</div>
					<!-- row -->
					<div class="row">
							...
							<div class="card">
								<div class="card-body">
									<div class="email-left-box generic-width px-0 mb-5">
										<div class="p-0">
											<a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=envio-mensajeria-usuarios-cashmanha" class="btn btn-primary btn-block">Enviar Nuevo Mensaje</a>
										</div>
										<div class="mail-list mt-4">
											<a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=envio-mensajeria-usuarios-cashmanha" class="list-group-item"><i class="fa fa-inbox font-18 align-middle mr-2"></i> Recibidos <span class="badge badge-primary badge-sm float-right"><?php echo NumeroMensajesRecibidosUsuarios_Secundario($conectarsistema3, $_SESSION['id_usuario']); ?></span> </a>
										</div>
									</div>
