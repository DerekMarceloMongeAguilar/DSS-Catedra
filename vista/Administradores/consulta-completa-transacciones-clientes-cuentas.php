...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Consulta General de Productos</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Consulta Transacciones Cuentas Clientes</h4>
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Consultar Transacciones Clientes</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                                ...
                                <div class="accordion__item">
                                    ...
                                    <div id="with-icon_collapseOne" class="accordion__body collapse" data-parent="#accordion-six">
                                        <div class="accordion__body--text">
                                            <i class="ti-direction"></i> Usted podr&aacute; consultar, ver comprobantes de pagos y anular transacciones realizadas previamente. <strong>Las transacciones que tienen que ser anuladas, deben tener la autorizaci&oacute;n de gerencia y presidencia. No puede anular una transacci&oacute;n sin el consentimiento de las partes antes mencionadas.</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Transacciones Cuentas Clientes </h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
                                                                print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todas las transacciones procesadas en las cuentas de ahorro de clientes. <strong> Puedes gestionar las respectivas y visualizar el respectivo comprobante de pago.</strong></p>
                                                <div class="table-responsive">
                                                    ...
                                                    <td style="font-size: .7rem;">';
                                                                ...
                                                                echo '</td>
                                                            <td style="font-size: .8rem;"><a href="javascript:void()" class="badge badge-rounded badge-';
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        ';
                                                                ...
                                                                echo '"><i class="ti-eye"></i> Ver Comprobante Pago</a>';
                                                                if (ucfirst($filas['tipotransaccion']) == "Entrada") {
                                                                    echo '
                                                                <a style="cursor: pointer;" id="anular-depositos" data-deposito-id="';
                                                                    echo $filas['idtransaccioncuentas'];
                                                                    echo '" class="dropdown-item"><i class="ti-na"></i>';
                                                                    if (ucfirst($filas['tipotransaccion']) == "Entrada") {
                                                                        echo " Anular Dep&oacute;sito Transacci&oacute;n";
                                                                    } else if (ucfirst($filas['tipotransaccion']) == "Salida") {
                                                                        echo " Anular Retiro Transacci&oacute;n";
                                                                    }
                                                                    echo '</a>
                                                                ';
                                                                } else if (ucfirst($filas['tipotransaccion']) == "Salida") {
                                                                    echo '
                                                                <a style="cursor: pointer;"  id="anular-retiros" data-retiro-id="';
                                                                    echo $filas['idtransaccioncuentas'];
                                                                    echo '" class="dropdown-item"><i class="ti-na"></i>';
                                                                    if (ucfirst($filas['tipotransaccion']) == "Entrada") {
                                                                        echo " Anular Dep&oacute;sito Transacci&oacute;n";
                                        ...
                                        <div class="tab-pane fade" id="profile8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar Transacciones Anuladas Cuentas Clientes CashMan H.A</h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
                                                                print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todas las transacciones que por alg&uacute;n motivo han sido anuladas. Puedes verificar el comprobante original de pago generado en su momento al procesar la informaci&oacute;n.</p>
    ...
    ***********************************-->
        ...
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-anular-depositos-clientes.js"></script>
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-anular-retiros-clientes.js"></script>
        <!-- Datatable -->
