...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Registro Retiros Cuentas de Ahorro</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Retiros Cuentas de Ahorro</h4>
                                </div>
                            </div>
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Retiros Cuentas de Ahorro</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Retiros Cuentas de Ahorro </h4><br>
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between">
                                                        <form data-id="<?php if (!empty($Gestiones->getUltimoIdTransaccionesDepositosRetirosCuentas())) {
                                                                        ...
                                                                        }  ?>" data-user-id="<?php echo $_GET['idusuario']; ?>" name="calculadora" id="ingreso-retiros-cuentas-ahorro-clientes" method="post" autocomplete="off" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row form-validation">
                                                                ...
                                                                <div class="col-lg-12 mb-5">
                                                                    <div class="form-group">
                                                                        <label class="text-label">Ingrese el monto a retirar <span class="text-danger">*</span></label>
                                                                        <small>El monto m&aacute;ximo de retiro es de $3,000.00 USD</small>
                                                                        <div class="col-lg-12">
                                                                            <input type="text" class="form-control" id="val-montoretirocuentaahorro" name="SaldoRetiroCuentaClientes" placeholder="$ USD" onInput="ValidarMontoTransferencias()" onkeypress="return (event.charCode <= 57)" onKeyUp="CalcularNuevoSaldoCliente()">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    </li>
                                                                        ...
                                                                        <div class="card-body p-4">
                                                                            <div class="media ai-icon">
                                                                                <span class="mr-3 bgl-danger text-danger">
                                                                                    <svg fill="#ff2e2e" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35">
                                                                                ...
                                                                                <div class="media-body">
                                                                                    ...
                                                                                    <h4 class="mb-0">$ <input style="border: 0; width: 6em;" type="text" name="resultado" id="val-resultadotransaccion" onInput="ValidarSaldoRetiroClientes()" value="<?php echo $Gestiones->getSaldoCuentaAhorroClientes(); ?>" disabled> USD</h4>
                                                                                    <span class="badge badge-danger">No. Cuenta -> <?php echo $Gestiones->getNumeroCuentaAhorroClientes(); ?></span>
                                                                                    <br><small>Cliente: <?php echo $Gestiones->getNombresUsuarios(); ?> <?php echo $Gestiones->getApellidosUsuarios(); ?></small>
                                                                                    <?php
                                                                                    if ($Gestiones->getSaldoCuentaAhorroClientes() > 1) {
                                                                                    ?>
                ...
                ?>
                    <div class="card-footer border-0 mt-0">
                        <button class="btn btn-primary btn-lg btn-block" id="registronuevascuentas" type="submit"><i class="fa fa-credit-card-alt"></i> Registrar Retiro No. Cuenta -> <?php echo $Gestiones->getNumeroCuentaAhorroClientes(); ?></button>
                    </div>
                <?php } else { ?>
                    <li class="list-group-item list-group-item-danger">Lo sentimos, por pol&iacute;ticas de la empresa los clientes no pueden dejar a $0.00 USD su cuenta en retiros normales.
                    </li>
                <?php } ?>
                </li>
                </form>
    ...
    ***********************************-->
        ...
        <script>
            ...
            function ValidarMontoTransferencias() {
                ...
                let IngresoDepositoClientes = $('#val-montoretirocuentaahorro').val(); // COMPROBACION DE DEPOSITO INGRESADO POR CLIENTES

                $('#registronuevascuentas').prop('disabled', true); // BLOQUEAR BOTON DE ENVIO POR DEFECTO
                let activador = document.getElementById("val-montoretirocuentaahorro")
                activador.addEventListener("keyup", () => {
                    if (activador.value > DepositoMaximoApertura || activador.value == 0 || activador.value < 0 || activador.value < 1) {
            ...
            function CalcularNuevoSaldoCliente() {
                ...
                var SaldoDepositoCuentaClientes = document.calculadora.SaldoRetiroCuentaClientes.value;
                try {
