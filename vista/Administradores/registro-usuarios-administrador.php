...
?>
	...
	<head>
		...
		<title>Aco Emprendedores | Registro Nuevos Usuarios</title>
		<!-- Favicon icon -->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Registrar Usuarios</h4>
								</div>
							</div>
				...
				<div class="container-fluid">
					<div class="page-titles">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0)">Registrar Usuarios</a></li>
						</ol>
					</div>
					<div class="row">
						<div class="col-xl-12">
							<div id="accordion-six" class="accordion accordion-with-icon accordion-danger-solid">
								...
								<?php
								// GENERAR CONTRASEÑA DINAMICA 10 CARACTERES
								if (isset($_POST['generar-clave-usuarios'])) {
									// CADENA DE CARACTERES DISPONIBLES PARA CONTRASEÑA
									$Cadena = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890";
									$ContraseniaAutomatica = "";
									// GENERAR CONTRASEÑA SEGUN CADENA Y LONGITUD DESEADA
									for ($i = 0; $i < 11; $i++) {
															...
															<div class="col-lg-6 mb-2">
																<div class="form-group">
																	...
																	<input type="hidden" id="claves-generadas" value="<?php if (!empty($ContraseniaAutomatica)) {
																														...
																														// VERIFICAMOS SI CONTRASEÑA GENERADA ES IGUAL A LA INGRESADA EN CAMPO INDICADO, SI CUMPLE CONDICION, SE PROCEDE A DESBLOQUEAR LOS DEMAS CAMPOS
																														?>">
																	<div class="col-lg-12">
																...
																<div class="form-group">
																	...
																	<div class="col-lg-12">
																		<select class="form-control" id="val-rol-usuarios" name="val-rol-usuarios">
																			...
																			<option value="2">Presidencia ACO Emprendedores</option>
																			<option value="3">Gerencia ACO Emprendedores</option>
																			<option value="4">Atenci&oacute;n Al Cliente ACO Emprendedores</option>
																			<option value="5">Clientes ACO Emprendedores</option>
																		</select>
																	</div>
																</div>
															</div>
														...
														<div class="alert alert-danger left-icon-big alert-dismissible fade show">
															<div class="media">
																...
																<div class="media-body">
																	...
																	<form action="../controlador/cGestionesCashman.php?cashmanhagestion=eliminar-datos-clientes-usuarios-anteriores" method="post">
												...
												<div class="col-lg-12 mb-2">
													...
													<td>
														<div class="d-flex">
															<a href="';
																	echo $UrlGlobal;
																	echo 'controlador/cGestionesCashman.php?cashmanhagestion=registro-detalles-usuarios-administrador&codigounicousuario=';
															...
															';
																	...
																	<a href="';
																			echo $UrlGlobal;
																			echo 'controlador/cGestionesCashman.php?cashmanhagestion=mostrar-informe-nuevos-clientes-administrador" target="_blank" class="btn btn-info shadow btn-xs sharp mr-1"><i class="mdi mdi-plus-box"></i></a>
																	';
																		}
																	}
																	echo '
