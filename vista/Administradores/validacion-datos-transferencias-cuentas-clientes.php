...
if ($_SESSION['comprobar_iniciosesion_primeravez'] == "si") {
    ...
    // NO PERMITIR TRANSFERENCIAS SI EL NUMERO DE CUENTA COINCIDE CON EL USUARIO LOGUEADO. ES DECIR AL MISMO USUARIO EN CUESTION
    if ($Gestiones->getIdCuentaAhorroTransferenciaDestinoClientes() == $_SESSION['id_usuario']) {
        header('location:../controlador/cGestionesCashman.php?cashmanhagestion=transferencia-otras-cuentas-clientes');
    } else {
?>
                            ...
                            <div class="collapse navbar-collapse justify-content-between">
                                <div class="header-left">
                                    <div class="dashboard_bar">
                                        <h4 style="font-weight: 600;">Validaci&oacute;n Datos Transferencias</h4>
                                    </div>
                                </div>
