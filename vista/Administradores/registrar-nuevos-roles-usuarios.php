...
?>
    ...
    <head>
        ...
        <title>Aco Emprendedores | Registro Nuevos Roles Usuarios</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Registrar Roles de Usuarios</h4>
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Registrar Roles de Usuarios</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                                    ...
                                    <div id="with-icon_collapseOne" class="accordion__body collapse" data-parent="#accordion-six">
                                        <div class="accordion__body--text">
                                            <i class="ti-direction"></i> Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                                        $PrimerNombre = explode(' ', $Nombre, 2);
                                                                                        print_r($PrimerNombre[0]); ?>, el registro de nuevos roles de usuarios, as&iacute; como su mantenimiento debe ser autorizado previamente en presidencia y gerencia.<strong> Le ser&aacute; notificado con much&iacute;sima anticipaci&oacute;n para realizar los respectivos cambios dentro del sistema.</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Registrar Nuevos Roles de Usuarios</h4><br>
                                                <div style="margin:0; padding:0;" id="resultados_ajax"></div>
                                                <form id="ingreso-nuevos-roles-usuarios" class="validacion-registro-roles-usuarios" method="post" autocomplete="off" enctype="multipart/form-data">
                                                    <div class="row form-validation">
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                <label class="text-label">Nombre de Rol de Usuario <span class="text-danger">*</span></label>
                                                                <div class="col-lg-12">
                                                                    <input type="text" class="form-control" id="val-nombrerolusuarios" name="val-nombrerolusuarios" placeholder="Ingrese el nombre del nuevo rol de usuario a registrar" onkeyup="javascript:this.value=this.value.toLowerCase();">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <textarea class="form-control" placeholder="Ingrese la descripci&oacute;n completa del nuevo rol de usuario a registrar" id="val-descripcion-rolusuarios" name="val-descripcion-rolusuarios" rows="3"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- ENVIO DATOS -->
                                                    <button id="registrorolesusuarios" type="submit" class="btn btn-rounded btn-primary"><span class="btn-icon-left text-primary"><i class="ti-user"></i></span>Registrar Rol de Usuario</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
    ...
    ***********************************-->
        ...
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-registro-roles-usuarios.js"></script>
        <!-- Datatable -->
