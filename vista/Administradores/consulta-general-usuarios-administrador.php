...
?>
	...
	<head>
		...
		<title>Aco Emprendedores | Consulta General de Usuarios</title>
		<!-- Favicon icon -->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Consultar Usuarios</h4>
								</div>
							</div>
								...
								<div class="card-body">
									...
									<div class="tab-content tabcontent-border">
										<div class="tab-pane fade show active" id="home8" role="tabpanel">
											<div class="pt-4">
												<h4>Consultar, Gestionar Usuario</h4><br>
												...
												<div class="table-responsive">
													...
													<td>
														...
														<a class="dropdown-item" href="';
																echo $UrlGlobal;
																echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-completa-usuarios-clientes&idusuario=';
																echo $filas['idusuarios'];
																echo '"><i class="ti ti-eye"></i> Ver Detalles Usuario</a>
													<a class="dropdown-item" href="';
																echo $UrlGlobal;
																echo 'controlador/cGestionesCashman.php?cashmanhagestion=modificar-usuarios-administrador&idusuario=';
																echo $filas['idusuarios'];
