...
if ($_SESSION['comprobar_iniciosesion_primeravez'] == "si") {
	...
	***********************************-->
								...
								<ul class="navbar-nav header-right">
									<li class="nav-item dropdown header-profile">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a href="<?php echo $UrlGlobal ?>controlador/cGestionesCashman.php?cashmanhagestion=perfiladministradores"
											...
											<a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=mensajeria-cashmanha-usuarios"
												class="dropdown-item ai-icon">
											...
											<a href="<?php echo $UrlGlobal ?>controlador/cIniciosSesionesUsuarios.php?cashmanha=cerrarsesion"
												class="dropdown-item ai-icon">
								...
								<div class="card">
									<div class="card-body">
										<div class="email-left-box generic-width px-0 mb-5">
											<div class="p-0">
												<a href=""
													class="btn btn-primary btn-block"><?php echo $Gestiones->getNombreProductos(); ?></a>
												<br>
											</div>
											<div class="text-center">
												...
												<h6 class="mt-4 mb-1"><?php echo $Gestiones->getNombresUsuarios(); ?>
													<?php echo $Gestiones->getApellidosUsuarios(); ?></h6>
													...
													<div class="right-box-padding">
														<div class="toolbar mb-4" role="toolbar">
															<div class="btn-group mb-1">
																<button type="button" class="btn btn-success light px-3"><i
																		class="fa fa-money"></i> Est&aacute; solicitud de
																	cr&eacute;dito ha sido aprobada en las &aacute;reas
																	correspondientes </button>
															</div>
														</div>
														<div class="read-content">
															<div class="media pt-3">
																<img class="mr-2 rounded" width="50" alt="image"
																	src="<?php echo $UrlGlobal; ?>vista/images/logo-negro.png">
																<div class="media-body mr-2">
																	<h5 class="text-primary mb-0 mt-1">Departamento
																		Jur&iacute;dico - ACO EMPRENDEDORES S.A de C.V</h5>
																	<p class="mb-0">Entrega de Contrato Colectivo -
																		<?php echo $Gestiones->getNombreProductos(); ?></p>
																</div>
															</div>
															<hr>
															<div class="media mb-2 mt-3">
																<div class="media-body"><span class="pull-right"
																		id="HoraActual"></span>
																	<h5 class="my-1 text-primary">Resumen de Contrato Colectivo
																	</h5>
															...
															<div class="read-content-body">
																<h5 class="mb-4">Por favor dar lectura al resumen de contrato
																	antes de iniciar nuevas acciones.</h5>
																<p class="mb-2">Estimado(a) cliente
																	<strong><?php echo $Gestiones->getNombresUsuarios(); ?>
																		<?php echo $Gestiones->getApellidosUsuarios(); ?>,</strong>
																	usted inici&oacute; una nueva solicitud de cr&eacute;dito
																	con nuestra empresa el d&iacute;a <?php $Fecha = $Gestiones->getFechaIngresoSolicitudCreditos();
																	...
																	echo ' del ' . $ObtenerAnio; ?>. En el
																	cual se le di&oacute; estudio y las respectivas &aacute;reas
																	asignadas han emitido un dictamen favorable de
																	<strong>aprobaci&oacute;n</strong> en su solicitud.</p>

																<p class="mb-2">Raz&oacute;n por la cual su cr&eacute;dito queda
																	estructurado de la siguiente manera:</p>

																<p class="mb-2">
																	<strong><?php echo $Gestiones->getNombreProductos(); ?></strong>
																	financiamiento por un monto de
																	<strong>$<?php echo number_format($Gestiones->getMontoFinanciamientoCreditos(), 2); ?>
																		USD</strong> para un plazo de
																	<strong><?php echo $Gestiones->getTiempoPlazoCreditos(); ?> 		<?php if ($Gestiones->getNombreProductos() == "Préstamos Hipotecarios") {
																					echo 'a&ntilde;os';
																				} else {
																					echo 'meses';
																				} ?></strong> a una tasa de
																	inter&eacute;s mensual del
																	<strong><?php echo $Gestiones->getTasaInteresCreditos(); ?>
																		%</strong>.</p>

																<p class="mb-2">Tomando en cuenta todo lo anterior, por
																	pol&iacute;ticas de nuestra empresa el d&iacute;a asignado
																	de su cuota mensual ser&aacute; el mismo en el cual usted
																	inicio su tr&aacute;mite de cr&eacute;dito, el cual
																	corresponde al <strong><?php echo $ObtenerDia; ?> de cada
																		mes por los pr&oacute;ximos
																		<?php echo $Gestiones->getTiempoPlazoCreditos(); ?> 		<?php if ($Gestiones->getNombreProductos() == "Préstamos Hipotecarios") {
																						echo 'a&ntilde;os';
																					} else {
																						echo 'meses';
																					} ?> o
																		cuando usted decida concluir con su responsabilidad
																		hacia nuestra empresa. <span style="color: #f00;">
																			Iniciando su responsabilidad de pago el
																			pr&oacute;ximo mes.</span></strong></p>

																<p class="mb-2">Respecto a los fines de semana, el tratamiento
																	de esos d&iacute;as es con los s&aacute;bados se le
																	sumar&aacute;n dos d&iacute;as posterior a su fecha de pago,
																	de igual forma con los domingos pero con la diferencia que
																	le ser&aacute; sumado un d&iacute;a &uacute;nicamente.</p>
															...
															<div class="read-content-attachment">
																...
																<div class="row attachment">
																	<div class="col-auto">
																		<p>* Imprimir estado de cuenta pagar&eacute; cuotas
																			mensualues y registrar cuotas mensuales asignadas en
																			el sistema de pagos <strong>(<?php
																		...
																		<a target="_blank"
																			href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=impresion-estado-cuenta-cuotas-nuevos-creditos&idusuario=<?php echo $Gestiones->getIdUsuarios(); ?>"
																			class="btn btn-outline-info"><i
																				class="fa fa-hourglass-start"></i> Generar
																			Estado de Cuenta</a><br>
															...
															if ($Gestiones->getNombreProductos() == "Préstamos de Vehículos") {
																	...
																	<div class="row attachment">
																		<div class="col-auto">
																			...
																			if (empty($Gestiones->getNumeroPlaca())) {
																				?>
																				<p>* Por favor solicite los formularios al cliente, e
																					ingrese la informaci&oacute;n solicitada en los
																					siguientes campos:</p>
																				<form id="registro-datos-vehiculos-contratos"
																					class="validacion-registro-datos-vehiculos-contrato"
																					method="post" autocomplete="off"
																					enctype="multipart/form-data">
																					<div class="row form-validation">
																						<div class="col-lg-6 mb-2">
																							<input type="hidden" name="idusuariocredito"
																								value="<?php echo $Gestiones->getIdUsuarios(); ?>">
																							<input type="hidden" name="idcredito"
																								value="<?php echo $Gestiones->getIdCreditos(); ?>">
																							<input type="hidden"
																								name="idproductocredito"
																								value="<?php echo $Gestiones->getIdProductos(); ?>">
																							<div class="form-group">
																								<label class="text-label">Placa <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-numeroplacavehiculo"
																										name="val-numeroplacavehiculo"
																										placeholder="Ingrese el n&uacute;mero de placa...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">Clase <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-tipoclasevehiculo"
																										name="val-tipoclasevehiculo"
																										placeholder="Ingrese la clase del veh&iacute;culo...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">A&ntilde;o
																									<span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-aniovehiculo"
																										name="val-aniovehiculo"
																										placeholder="Ingrese el a&ntilde;o del veh&iacute;culo...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">Capacidad
																									<span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-capacidadvehiculo"
																										name="val-capacidadvehiculo"
																										placeholder="Ingrese la capacidad del veh&iacute;culo...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">Asientos <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-asientosvehiculo"
																										name="val-asientosvehiculo"
																										placeholder="Ingrese el n&uacute;mero de asientos...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">Marca <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-marcavehiculo"
																										name="val-marcavehiculo"
																										placeholder="Ingrese la marca del veh&iacute;culo...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">Modelo <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-modelovehiculo"
																										name="val-modelovehiculo"
																										placeholder="Ingrese el modelo del veh&iacute;culo...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">N&uacute;mero
																									de Motor <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-numeromotorvehiculo"
																										name="val-numeromotorvehiculo"
																										placeholder="Ingrese el n&uacute;mero del motor...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								<label class="text-label">N&uacute;mero
																									de Chasis Grabado <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-numerochasisvehiculo"
																										name="val-numerochasisvehiculo"
																										placeholder="Ingrese el n&uacute;mero de chasis grabado...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-6 mb-2">
																							<div class="form-group">
																								...
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-numerochasisvinvehiculo"
																										name="val-numerochasisvinvehiculo"
																										placeholder="Ingrese el Chasis VIN...">
																								</div>
																							</div>
																						</div>
																						<div class="col-lg-12 mb-2">
																							<div class="form-group">
																								<label class="text-label">Color <span
																										class="text-danger">*</span></label>
																								<div class="col-lg-12">
																									<input type="text"
																										class="form-control"
																										id="val-colorvehiculo"
																										name="val-colorvehiculo"
																										placeholder="Ingrese el color del veh&iacute;culo...">
																								</div>
																							</div>
																						</div>
																					</div>
																					...
																					<button type="submit"
																						class="btn btn-rounded btn-primary"><span
																							class="btn-icon-left text-primary"><i
																								class="ti-car"></i></span>Registrar
																						Especificaciones de Veh&iacute;culos</button>
																				</form>
																			<?php } else { ?>
																				<div
																					class="alert alert-success solid alert-dismissible fade show">
																					<strong>Perfecto!</strong> Los respectivos datos
																					solicitados del veh&iacute;culo han sido registrados
																					con &eacute;xito. Ahora puedes generar el contrato
																					al cliente final.
																				</div>
																			<?php } ?>
																...
																<div class="read-content-attachment">
																	...
																	<div class="row attachment">
																		<div class="col-auto">
																			<p>* Imprimir contrato final de solicitud crediticia
																				aprobada del cliente. <strong>El cual deber&aacute;
																					firmar el cliente y entregar una copia del
																					mismo.<span style="color: #f00;"> Todos los
																						clientes tendr&aacute;n disponible la copia
																						del mismo en su portal.</span></strong></p>
																			<a target="_blank"
																				href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=impresion-contrato-final-clientes&idusuario=<?php echo $Gestiones->getIdUsuarios(); ?>"
																				class="btn btn-outline-info"><i
																					class="fa fa-gavel"></i> Generar Contrato de
																				Solicitud Crediticia</a><br>
																...
																<div class="read-content-attachment">
																	...
																	<div class="row attachment">
																		<div class="col-auto">
																			<p>* Subir copia de contrato final clientes,
																				aseg&uacute;rese de elegir el archivo correcto</p>
																			<div
																				class="alert alert-warning solid alert-dismissible fade show">
																				...
																				<strong>¡Advertencia!</strong> ¿Est&aacute; seguro
																				de registrar este documento? <strong>Es una
																					acci&oacute;n sin retorno ya que todo el proceso
																					de asignaci&oacute;n de nuevos cr&eacute;ditos
																					finalizar&iacute;a
																					autom&aacute;ticamente.</strong> Por favor
																				verifique que todo ha sido completado con
																				&eacute;xito antes de realizar esta acci&oacute;n.
																			</div>
																			<form id="registro-contrato-copia-clientes"
																				class="validacion-registro-datos-vehiculos-contrato"
																				method="post" autocomplete="off"
																				enctype="multipart/form-data">
																				<div class="row form-validation">
																					<div class="col-lg-12 mb-2">
																						<div class="form-group">
																							<label class="text-label">Adjuntar
																								Documento <span
																									class="text-danger">*</span></label>
																							<div class="col-lg-12">
																								<input name="idcreditocontrato"
																									type="hidden"
																									value="<?php echo $Gestiones->getIdCreditos(); ?>">
																								<input type="file" <?php if (empty($Gestiones->getNumeroPlaca())) {
																									echo "disabled style='cursor: no-drop;''";
																								} ?> name="val-copiacontratousuarios"
																									id="val-copiacontratousuarios"
																									class="dropify" accept=".pdf"
																									data-allowed-file-extensions="pdf" />
																							</div>
																						</div>
																					</div>
																					<p>* Le recordamos si ha omitido un paso
																						anterior y usted hace clic en el
																						bot&oacute;n. NO podr&aacute; revertir esta
																						acci&oacute;n, ya que el proceso finaliza
																					...
																					<button <?php if (empty($Gestiones->getNumeroPlaca())) {
																						...
																						class="btn btn-rounded btn-primary"><span
																							class="btn-icon-left text-primary"><i
																								class="fa fa-file-pdf-o"></i></span>Registrar
																						Contrato Final Clientes</button>
																			</form>
		...
		***********************************-->
					<div class="footer">
						<div class="copyright">
							<p>Copyright &copy; <?php echo date('Y'); ?>  &amp; Desarrollo de Sistemas ACO EMPRENDEDORES
							</p>
						</div>
					</div>
					<!--**********************************
	...
	***********************************-->
				...
				<script
					src="<?php echo $UrlGlobal; ?>vista/vendor/jquery-asColorPicker/js/jquery-asColorPicker.min.js"></script>
				<!-- Material color picker -->
				<script
