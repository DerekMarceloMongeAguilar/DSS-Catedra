								...
								<div class="card-body">
									<div class="email-left-box px-0 mb-3">
										...
										<div class="mail-list mt-4">
											<a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=envio-mensajeria-usuarios-cashmanha" class="list-group-item"><i class="fa fa-inbox font-18 align-middle mr-2"></i> Recibidos <span class="badge badge-primary badge-sm float-right"><?php echo NumeroMensajesRecibidosUsuarios($conectarsistema5, $_SESSION['id_usuario']); ?></span> </a>
										</div>
