...
?>
		...
		<head>
			...
			<title>Aco Emprendedores | Gestionar Cr&eacute;dito <?php echo $Gestiones->getNombreProductos(); ?> </title>
			<!-- Favicon icon -->
							...
							<div class="collapse navbar-collapse justify-content-between">
								<div class="header-left">
									<div class="dashboard_bar">
										<h4>Gestionar Nuevos <?php echo $Gestiones->getNombreProductos(); ?></h4>
									</div>
								</div>
