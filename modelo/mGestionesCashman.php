...
class GestionesClientes
{
    ...
    // -> CONSULTA PRODUCTOS ACO EMPRENDEDORES HA
    private $IdProductos;
    ...
    // -> CREDITOS ACO EMPRENDEDORES HA [AUXILIAR]
    private $IdCreditosAuxiliar;
    // -> CREDITOS ACO EMPRENDEDORES HA [CONSULTA COMPLETA NO AUXILIAR]
    private $IdCreditos;
    ...
    // -> RERERENCIAS PERSONALES - LABORALES -> CLIENTES ACO EMPRENDEDORES HA 
    ...
    // -> DATOS DE CUOTAS GENERADAS CLIENTES ACO EMPRENDEDORES H.A -> CONSULTAS ESPECIFICAS Y COMPLETAS
    ...
    /*
            << ROLES DE USUARIOS ACO EMPRENDEDORES HA >>
    ...
    /*
            << PRODUCTOS ACO EMPRENDEDORES HA >>
    ...
    /*
            << REFERENCIAS PERSONALES - LABORALES CREDITOS ACO EMPRENDEDORES HA >>
    ...
    /*
            << REFERENCIAS PERSONALES -> LABORALES ACO EMPRENDEDORES HA >>
    ...
    /*
            << CONSULTA DE MENSAJERIA ACO EMPRENDEDORES H.A USUARIOS >>
    ...
    /*
            << CONSULTA DATOS CUENTAS DE AHORRO CLIENTES ACO EMPRENDEDORES H.A >>
    ...
    /*
            << CONSULTA DATOS TRANSACCIONES REALIZADAS CUENTAS DE CLIENTES ACO EMPRENDEDORES H.A >>
    ...
    /*
            << CONSULTA DATOS TRANSFERENCIAS CLIENTES -> CUENTAS DE DESTINO FINAL ACO EMPRENDEDORES H.A >>
        */
    ...
    // REGISTRAR NUEVOS PRODUCTOS ACO EMPRENDEDORESHA -> USO EXCLUSIVO ROL [ADMINISTRADORES]
    ...
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA [ACTIVOS] -> EMPLEADOS - ADMINISTRADOR
    ...
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA [INACTIVOS] -> EMPLEADOS - ADMINISTRADOR
    ...
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA [EXPIRADOS] -> EMPLEADOS - ADMINISTRADOR
    ...
    // MODIFICAR PRODUCTOS ACO EMPRENDEDORESHA -> [ADMINISTRADORES, PRESIDENCIA, GERENCIA]
    ...
    // CONSULTA GENERAL DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA ACTIVOS -> CAMPO SELECT NUEVOS CREDITOS
    ...
    // CONSULTA ESPECIFICA DE CUOTAS GENERADAS CLIENTES ACO EMPRENDEDORES H.A -> CREDITOS ACTIVOS [EN CURSO]
    ...
    // CONSULTA ESPECIFICA DE CUOTAS GENERADAS CLIENTES ACO EMPRENDEDORES H.A -> CREDITOS CANCELADOS [HISTORICOS]
    ...
    // CONSULTA BANDEJA DE ENTRADA -> MENSAJERIA USUARIOS ACO EMPRENDEDORES HA
    ...
    // CONSULTA DETALLES DE MENSAJERIAS BANDEJA DE ENTRADA -> MENSAJERIA USUARIOS ACO EMPRENDEDORES HA
    ...
    // CONSULTA DE TODOS LOS USUARIOS REGISTRADOS DISPONIBLES PARA ENVIO DE MENSAJERIA INTERNA ACO EMPRENDEDORES HA
    ...
    // REGISTRO DE NUEVOS MENSAJES -> ENVIO MENSAJERIA INTERNA ACO EMPRENDEDORES H.A
    ...
    // OCULTAR MENSAJES RECIBIDOS -> MENSAJERIA INTERNA ACO EMPRENDEDORES H.A 
    ...
    // REGISTRO DE NUEVAS CUENTAS DE AHORROS CLIENTES ACO EMPRENDEDORES H.A
    ...
    // REGISTRO DEPOSITOS CUENTAS DE AHORROS CLIENTES ACO EMPRENDEDORES H.A
    ...
    // REGISTRO RETIROS CUENTAS DE AHORROS CLIENTES ACO EMPRENDEDORES H.A
    ...
    */
    ...
    // CONSULTA AVANCE DE CREDITOS ASIGNADOS CLIENTES -> VALIDO PARA INTERFAZ DE INICIO CLIENTE ACO EMPRENDEDORES H.A
