...
// IMPORTANDO MODELO RECUPERACION DE GESTIONES EMPRESARIALES Aco Emprendedores
...
switch ($peticion_url) {
    ...
    case "perfiladministradores":
        ...
        if ($_SESSION['id_rol'] == 1) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIOS
            // CONSULTA DETALLES DE USUARIOS {EMPLEADOS, CLIENTES Aco Emprendedores} -> PERFIL DE USUARIOS
            $consulta = $Gestiones->ConsultarDetallesUsuarios($conectarsistema, $IdUsuarios);
            // CONSULTA CONFIGURACION CUENTA DE USUARIOS {EMPLEADOS, CLIENTES Aco Emprendedores} -> PERFIL DE USUARIOS
    ...
    case "consultar-productos-cashmanha":
        ...
        if ($_SESSION['id_rol'] == 1) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIO REGISTRADO
            // CONSULTA COMPLETA DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA [ACTIVOS]
            $consulta = $Gestiones->ConsultarProductosCashManHA_Activos($conectarsistema);
            // CONSULTA COMPLETA DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA [INACTIVOS]
            $consulta1 = $Gestiones->ConsultarProductosCashManHA_Inactivos($conectarsistema1);
            // CONSULTA COMPLETA DE PRODUCTOS REGISTRADOS ACO EMPRENDEDORESHA [EXPIRADOS]
    ...
    case "expirar-productos-cashmanha":
        ...
        break;
        // CONSULTA ESPECIFICA PRODUCTOS REGISTRADOS ACO EMPRENDEDORES HA -> ADMINISTRADORES
    case "consulta-productos-especifica-cashmanha":
        ...
        break;
        // CONSULTA ESPECIFICA PRODUCTOS REGISTRADOS ACO EMPRENDEDORES HA -> PRESIDENCIA
    case "consulta-productos-especifica-cashmanha-presidencia":
        ...
        break;
        // CONSULTA ESPECIFICA PRODUCTOS REGISTRADOS ACO EMPRENDEDORES HA -> GERENCIA
    case "consulta-productos-especifica-cashmanha-gerencia":
        ...
        break;
        // CONSULTA ESPECIFICA PRODUCTOS REGISTRADOS ACO EMPRENDEDORES HA -> ATENCION AL CLIENTE
    case "consulta-productos-especifica-cashmanha-atencion-clientes":
        ...
        break;
        //  MODIFICAR PRODUCTOS REGISTRADOS ACO EMPRENDEDORES HA -> [PAGINA] {ADMINISTRADORES}
    case "modificar-productos-cashmanha":
        ...
        break;
        //  MODIFICAR PRODUCTOS REGISTRADOS ACO EMPRENDEDORES HA -> [PAGINA] {PRESIDENCIA}
    ...
    case "reestructuracion-solicitudes-creditos-clientes-presidencia":
        ...
        break;
        // PAGINA DE ASIGNACION DE NUEVOS CREDITOS CLIENTES ACO EMPRENDEDORES H.A [INFORMACION CLIENTES]
    ...
    case "gestor-creditos-seleccion-producto-clientes":
        ...
        break;
        // PAGINA DE ASIGNACION DE NUEVOS CREDITOS CLIENTES ACO EMPRENDEDORES H.A [PRESTAMOS PERSONALES]
    ...
    case "envio-datos-asignacion-prestamos-cashmanha-clientes":
        ...
        break;
        // PAGINA DE ASIGNACION DE REFERENCIAS PERSONALES CLIENTES NUEVOS / ANTIGUOS -> ACO EMPRENDEDORES H.A
    ...
    case "envio-datos-modificar-referencias-personales-laborales-clientes":
        ...
        break;
        // PAGINA DE ASIGNACION DE NUEVOS CREDITOS CLIENTES ACO EMPRENDEDORES H.A [PRESTAMOS HIPOTECARIOS]
    ...
    case "impresion-estado-cuenta-cuotas-nuevos-creditos":
        ...
        if ($_SESSION['id_rol'] == 1) {
            ...
            // CONSULTA PRODUCTOS ACTIVOS -> ASIGNACIONES NUEVOS CREDITOS
            $consulta1 = $Gestiones->ConsultarProductosActivosNuevosCreditos($conectarsistema1);
            // CONSULTA GENERAL DE CUOTAS GENERADAS SEGUN PRODUCTO ASOCIADO CLIENTES ACO EMPRENDEDORES H.A
    ...
    case "impresion-estado-cuenta-cuotas-nuevos-creditos-portal-clientes":
        // VISTA VALIDA PARA CLIENTES [PORTAL DE CLIENTES ACO EMPRENDEDORES H.A]
        if ($_SESSION['id_rol'] == 5) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIOS
            // CONSULTA COMPLETA DE CLIENTE CON TODOS LOS REQUERIMIENTOS SOLICITADOS EN SOLICITUD DE CREDITO
            $consulta = $Gestiones->ConsultaDatosSolicitudesCreditosClientesAprobados($conectarsistema, $IdUsuarios);
    ...
    case "envio-datos-actualizacion-tickets-problemas-plataforma":
        ...
        break;
        // PAGINA DE SISTEMA DE PAGOS CUOTAS CREDITOS CLIENTES ACO EMPRENDEDORES H.A -> DISPONIBLE PARA LOS USUARIOS ADMINISTRATIVOS -> [ADMINISTRADORES Y ATENCION AL CLIENTE]
    ...
    case "sistema-pagos-creditos-cashmanha-clientes-atencion-al-cliente":
        ...
        break;
        // PAGINA DE SISTEMA DE PAGOS CUOTAS CREDITOS CLIENTES ACO EMPRENDEDORES H.A [ESPECIFICAMENTE ORDENES DE PAGO SEGUN LA CUOTA A CANCELAR {ID DE CUOTA GENERADA EN SISTEMA}] -> DISPONIBLE PARA LOS USUARIOS ADMINISTRATIVOS -> [ADMINISTRADORES Y ATENCION AL CLIENTE]
    ...
    case "consulta-general-transacciones-procesadas-por-clientes-gerencia":
        ...
        break;
        // PAGINA DE MENSAJERIA INTERNA ACO EMPRENDEDORES H.A -> VALIDO PARA TODOS LOS USUARIOS ADMINISTRATIVOS [ADMINISTRADORES, PRESIDENCIA, GERENCIA, ATENCION AL CLIENTE Y CLIENTES]
    ...
    case "mensajeria-cashmanha-usuarios-clientes":
        ...
        break;
        // PAGINA DE DETALLES MENSAJERIA INTERNA ACO EMPRENDEDORES H.A -> VALIDO UNICAMENTE PARA TODOS LOS USUARIOS [ADMINISTRADORES, PRESIDENCIA, GERENCIA, ATENCION AL CLIENTE Y CLIENTES]
    ...
    case "detalle-mensajeria-cashmanha-usuarios-clientes":
        ...
        break;
        // PAGINA DE ENVIO MENSAJERIA INTERNA ACO EMPRENDEDORES H.A -> VALIDO UNICAMENTE USUARIOS ADMINISTRATIVOS [NO APLICABLE PARA CLIENTES ACO EMPRENDEDORES H.A]
    ...
    case "envio-datos-ocultar-notificaciones-usuarios":
        ...
        break;
        // REGISTRO DE NUEVAS CUENTAS DE AHORROS CLIENTES ACO EMPRENDEDORES H.A -> VALIDO PARA ADMINISTRADORES Y ATENCION AL CLIENTE
    ...
    case "registro-nuevas-cuentas-ahorro-atencion-clientes":
        ...
        break;
        // ENVIO DATOS REGISTRO DE NUEVAS CUENTAS DE AHOROO CLIENTES ACO EMPRENDEDORES H.A [ENVIO A BASE DE DATOS]
    ...
    case "gestionador-cuentas-ahorros-clientes-atencion-clientes":
        ...
        break;
        // REGISTRO NUEVOS DEPOSITOS CUENTAS DE AHORROS CLIENTES ACO EMPRENDEDORES H.A
    ...
    case "impresion-comprobantes-transacciones-cuentas-clientes":
        ...
        break;
        // REGISTRO NUEVOS RETIROS CUENTAS DE AHORROS CLIENTES ACO EMPRENDEDORES H.A
        // VALIDO PARA ADMINISTRADORES Y ATENCION AL CLIENTE
    ...
    case "generador-codigos-transferencias-clientes":
        ...
        if ($_SESSION['id_rol'] >= 1 && $_SESSION['id_rol'] <= 5) {
            ...
            $Nombre = "Aco Emprendedores - Soporte Sistemas"; // NOMBRE POR DEFECTO EMPRESA
            $Remitente = "jjpm836@gmail.com"; // CORREO DE RECUPERACION DE CUENTAS -> EMPRESA
            $Asunto = "Código Seguridad - Transferencias Aco Emprendedores"; // ASUNTO POR DEFECTO DE CORREO
            ...
            if (empty($IdUsuarios)) {
                ...
                try {
                    ...
                    $mail->Username = '9c27fc61e9c1b8'; // NOMBRE DE USUARIO
                    $mail->Password = '93a564e9752af6'; // CLAVE DE ACCESO
    ...
    case "bienvenida-clientes":
        // VISTA EXCLUSIVA UNICAMENTE PARA CLIENTES ACO EMPRENDEDORES HA
        if ($_SESSION['id_rol'] == 5) {
            $IdUsuarios = $_SESSION['id_usuario']; // ID UNICO DE USUARIO REGISTRADO
